        ...
        implements AutoCloseable
{
    ...
    public StarRocksOperationApplier(String database, String table, StreamLoadProperties properties, HttpClientBuilder clientBuilder)
    {
        ...
        this.region = new StreamTableRegion(uniqueKey, database, table, properties.getLabelPrefix(), this, tableProperties);
